...
<head>
    ...
    <title>{{ Auth::user()->datos_generales->nombre }} {{ Auth::user()->datos_generales->apellido_paterno }}
        {{ Auth::user()->datos_generales->apellido_materno }}</title>
    <!-- Fonts -->
...
<body class="font-sans antialiased bg-gray-100">
    <div class="min-h-screen">
        ...
        <!-- Page Heading -->
        @if (isset($header))
            <header class="shadow" style="background:rgb(27,57,106);">
